...
- [operations-reference.md](architecture/operations-reference.md) — Where everything lives: file paths, VM commands, AWS console locations, debugging checklist
...
- [reference-games.md](research/reference-games.md) — Games that inspire the design and exemplify design principles
